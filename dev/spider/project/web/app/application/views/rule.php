...
ユーザーは、<em class="site-name"><?php echo SITE_NAME; ?></em>内で行うあらゆる行為において、<a href="/term">利用規約の禁止事項</a>に含まれる行為をしてはいけません。
また、<em class="site-name"><?php echo SITE_NAME; ?></em>に投稿されたユーザーコンテンツ（スレッドやレス等）は、コンテンツを投稿したユーザー自身が管理するものとします。</p>
	...
	<section>
		...
		<div class="toggle" id="toggle-2-2">
			<p><em class="site-name"><?php echo SITE_NAME; ?></em>は、全てのユーザーがスレッドオーナーとなり、自分のスレッドを運営できるのが最大の特徴です。
