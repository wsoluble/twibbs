...
?>
<h2><i class="fa fa-pencil" aria-hidden="true"></i>新規スレッド</h2>
<form id="form-thread" method="post" action="/post/thread">
<h3><var>1</var>タイトル</h3>
...
<h4><i class="fa fa-folder-open" aria-hidden="true"></i>カテゴリルール</h4>
<?php
	foreach ($categories as $category) {
?>
