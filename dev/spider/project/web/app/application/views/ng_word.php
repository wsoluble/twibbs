...
?>
<h2><i class="fa fa-ban" aria-hidden="true"></i>NGワード設定（<?php echo $ng_count; ?>）</h2>
<ul class="exp">
...
?>
<li>
<span><i class="fa fa-ban" aria-hidden="true"></i><?php echo $ng; ?></span>
<button class="remove-ng-word" type="submit" name="submit_remove" value="<?php echo $ng; ?>"><i class="fa fa-times" aria-hidden="true"></i></button>
</li>
<?php
	}
}
