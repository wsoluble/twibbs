...
<ul class="footer">
<li class="number"><span>#</span><var><?php echo $comment->comment_id; ?></var></li>
<?php
...
?>
<button class="extend-display" type="button" data-target="ellipsis-<?php echo $comment->comment_id; ?>"><i class="fa fa-ellipsis-v" aria-hidden="true"></i></button>
<ul class="extend-ellipsis ellipsis-<?php echo $comment->comment_id; ?>">
<?php
