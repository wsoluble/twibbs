...
<h1><a href="/t/<?php echo $thread->thread_id; ?>"><?php echo !empty($thread) ? $thread->t_title : ''; ?></a></h1>
...
<ul class="footer">
<li class="number"><span>#</span><em>0</em></li>
<?php
...
<a href="https://twitter.com/<?php echo $thread->u_twitter_id; ?>" class="twitter-follow-button" data-show-count="false" data-show-screen-name="false">Follow @<?php echo $thread->u_twitter_id; ?></a>
</div>
<?php
}
?>
