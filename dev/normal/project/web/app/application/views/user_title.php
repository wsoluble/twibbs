...
switch ($method) {
	case '':
?><h1 class="user-title"><span>@<?php echo $user->u_twitter_id; ?></span>さんのレス</h1><?php
		break;

	case 'thread':
?><h1 class="user-title"><span>@<?php echo $user->u_twitter_id; ?></span>さんのスレッド</h1><?php
		break;

	case 'bookmark':
?><h1 class="user-title"><span>@<?php echo $user->u_twitter_id; ?></span>さんのぶくま！</h1><?php
		break;

	case 'report_res':
?><h1 class="user-title"><span>@<?php echo $user->u_twitter_id; ?></span>さんのレススパム報告</h1><?php
		break;

	case 'report_thread':
?><h1 class="user-title"><span>@<?php echo $user->u_twitter_id; ?></span>さんのスレッドスパム報告</h1><?php
		break;
