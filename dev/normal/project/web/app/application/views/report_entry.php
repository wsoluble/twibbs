...
<ul class="footer">
<?php
if (!empty($report->rt_name)) {
?>
<li class="report"><i class="fa fa-frown-o" aria-hidden="true"></i><span><?php echo $report->rt_name; ?></span></li>
<?php
}
if (!empty($disp_link)) {
?>
...
?>
<button class="extend-display" type="button" data-target="ellipsis-<?php echo $type.$tid; ?>-<?php echo $uid; ?>"><i class="fa fa-ellipsis-v" aria-hidden="true"></i></button>
<ul class="extend-ellipsis ellipsis-<?php echo $type.$tid; ?>-<?php echo $uid; ?>">
